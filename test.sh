...
#	./simpsh --parallel 3--rdonly hi.txt --pipe --pipe --pipe --rdonly finbert.txt --rdonly errbert.txt --command 0 2 8 cat hi.txt --command 1 4 8 sort --command 3 6 8 tr ' ' 'a' --command 4 7 8 tr '[0-9]' '[a-j]' --wait
